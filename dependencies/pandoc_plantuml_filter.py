...
see: https://plantuml.com/de/command-line
https://github.com/timofurrer/pandoc-plantuml-filter/blob/master/pandoc_plantuml_filter.py
"""
...
def plantuml(key, value, format_, _):
    if key == 'CodeBlock':
        ...
        if "plantuml" in classes:
            ...
            filetype = "svg" # DK: why not always pretty?
